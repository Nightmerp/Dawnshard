...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbFriend", b =>
                {
                    b.Property<long>("ViewerId1")
                        .HasColumnType("bigint");

                    b.Property<long>("ViewerId2")
                        .HasColumnType("bigint");

                    b.Property<int>("FriendStatus")
                        .HasColumnType("integer");

                    b.Property<bool>("ViewerID1Viewed")
                        .HasColumnType("boolean");

                    b.Property<bool>("ViewerID2Viewed")
                        .HasColumnType("boolean");

                    b.HasKey("ViewerId1", "ViewerId2");

                    b.HasIndex("ViewerId2");
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbPlayerSupportChara", b =>
                {
                    b.Property<long>("ViewerId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbSummonTicket", b =>
                {
                    ...
                    b.Property<int>("SummonTicketId")
                        .HasColumnType("integer")
                        .HasColumnName("Type");

                    b.Property<DateTimeOffset>("UseLimitTime")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbFriend", b =>
                {
                    b.HasOne("DragaliaAPI.Database.Entities.DbPlayer", "Player1")
                        .WithMany()
                        .HasForeignKey("ViewerId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DragaliaAPI.Database.Entities.DbPlayer", "Player2")
                        .WithMany()
                        .HasForeignKey("ViewerId2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DragaliaAPI.Database.Entities.DbTimeAttackPlayer", b =>
                {
                    b.HasOne("DragaliaAPI.Database.Entities.DbTimeAttackClear", "Clear")
                        .WithMany("Players")
